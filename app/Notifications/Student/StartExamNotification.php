...
class StartExamNotification extends Notification implements ShouldQueue
{
    use Queueable;
    protected $urlExam = '';
    protected $message = '';
    ...
    public function __construct(protected Exam $exam, protected User $student)
    {
        ...
        $this->message = "Cuộc thi {$exam->title} đã được bắt đầu vào lúc {$exam->start_date}";
    }
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->line("Cuộc thi {$this->exam->title} đã được bắt đầu")
